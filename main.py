...
user_input = "" #create an empty string
sandwich_pos = 0
drink_pos = 1
fries_pos = 2
ketchup_pos = 3
...
while user_input != "no":
	order_list = ["", "", "", 0] #important to reset the order list to blank
	...
	if order_list[drink_pos] != "no" and order_list[fries_pos] != "no":
		total_cost -= 1.00
	...
	user_input = input("Can I get anything else for you? (yes/no)\n").strip().lower()
